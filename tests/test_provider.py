...
def test_provider_is_not_mintable(provider: OidcIdentityProvider) -> None:
    # The capability-gate proof: this member validates only. It IS an
    # IdentityProvider but must NOT be an ApiKeyIdentityProvider, so the
    # skeleton's key-minting surface refuses it loudly.
